 ...
 */
final class Version20220707185123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE booking (id INT AUTO_INCREMENT NOT NULL, car_id INT NOT NULL, station_id INT NOT NULL, charge_start DATETIME NOT NULL, charge_end DATETIME NOT NULL, UNIQUE INDEX UNIQ_E00CEDDEC3C6F69F (car_id), UNIQUE INDEX UNIQ_E00CEDDE21BDB235 (station_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE city (id INT AUTO_INCREMENT NOT NULL, city VARCHAR(255) NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, country VARCHAR(255) NOT NULL, iso VARCHAR(255) NOT NULL, admin_name VARCHAR(255) NOT NULL, capital VARCHAR(255) DEFAULT NULL, population INT NOT NULL, population_proper INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE location (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, price DOUBLE PRECISION NOT NULL, city VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE station (id INT AUTO_INCREMENT NOT NULL, location_id INT NOT NULL, type VARCHAR(255) NOT NULL, power DOUBLE PRECISION NOT NULL, INDEX IDX_9F39F8B164D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
